...
export function Transfers() {
  return (
    <section className="bg-[#f8faf9] py-[110px] max-[620px]:py-[78px]" id="transfers">
      <div className="mx-auto w-[min(1120px,calc(100%-40px))] max-[620px]:w-[min(1120px,calc(100%-28px))]">
        ...
        <div className="grid grid-cols-2 gap-4 max-[620px]:grid-cols-1">
          {transfers.map((route) => (
            <a key={route} className="flex items-center gap-4 rounded-[18px] border border-[#e5ebe8] bg-white px-6 py-[22px] shadow-[0_8px_28px_rgba(26,50,42,.05)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_34px_rgba(26,50,42,.1)] max-[620px]:p-[18px]" href={getWhatsAppLink(`Olá! Gostaria de informações e orçamento para o traslado ${route}.`)} target="_blank" rel="noreferrer">
